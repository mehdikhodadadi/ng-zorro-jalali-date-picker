...
import { ɵComponentBed as ComponentBed, ɵcreateComponentBed as createComponentBed } from '../core-testing';
import { NzIconTestModule } from '../icon-testing';
...
// https://github.com/NG-ZORRO/jalali-date-picker/issues/2191
@Component({
  template: `
...
// https://github.com/NG-ZORRO/jalali-date-picker/issues/3079
@Component({
  template: `
    <button nz-button>
      {{ title }}
